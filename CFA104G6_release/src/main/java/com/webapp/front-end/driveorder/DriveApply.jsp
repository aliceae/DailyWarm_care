		...
		<div class="container px-4 px-lg-0">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto my-2 my-lg-0">
					...
					<!-- 首頁 -->
					<li class="nav-item"><a class="nav-link" id="firstpage"
						href="#">首頁</a></li>
					<!-- 關於我們 -->
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item"
								href="driveorder/MyDriveOrder.html">派車</a></li>
						</ul></li>
					<!-- 通知 -->
					<li class="nav-item"><a class="nav-link" href="#">通知</a></li>
					<!-- 會員 -->
					<li id="member" class="nav-item dropdown"><a class="nav-link"
						id="navbarDropdown" role="button" data-bs-toggle="dropdown"
						aria-expanded="false"> <i class="fas fa-user-circle fa-2x "></i>
					</a>
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" id="switchAcct"
								href="Carer.html">切換帳號</a></li>
							<li><a class="dropdown-item" id="applyCarer" href="">申請成為照護員</a></li>
							<li><a class="dropdown-item" id="memberData"
								href="./setMemData.html">會員資料設定</a></li>
	...
	<section class="page-section" id="portfolio" style="background-color:#f1d683">
		<div class="container px-4 px-lg-5" style="margin-top:30px">
			...
			<div class="row gx-4 gx-lg-5 justify-content-center mb-5">
				...
				<div class="col-lg-6" id= "googleMap" style="width:50%;height: 550px;">
				</div>
			</div>
			<div class="row gx-4 gx-lg-5 justify-content-center">
