...
<body id="page-top">
	...
	<div
		style="margin: 100px 100px; position: relative; display: flex; flex-direction: column; min-width: 0; word-wrap: break-word; background-color: #fff; background-clip: border-box; border: 1px solid #e3e6f0; border-radius: 0.35rem;">
...
<!-- 					onclick="location.href='noticeCenter.jsp'"> -->
				...
				<c:forEach var="pvo" items="${list}">
					...
					<tr>
						...
						<th scope="col">
							...
							<div id="dialogcheck${pvo.mailId}" style="display: none;">
			...
			<div class="card-head">
				<form method="post" action="<%=request.getContextPath()%>/front-end/mailbox/mail.do">
					<table class="table table-bordered">
						<tr>
							<th>收件人</th>
							<td><input type="text" id="" name="receiveMemId" value="${memberMailBoxVO.receiveMemId}" placeholder="請輸入收件人"/></td>
						</tr>
						<tr>
							<th>標題</th>
							<td><input type="text" name="msgTitle" value="${memberMailBoxVO.msgTitle}" placeholder="請輸入標題"/></td>
						</tr>
						<tr>
							<th>內容</th>
							<td>
								<textarea name="msgContent" cols="50" rows="8" placeholder="請輸入內容"></textarea>
