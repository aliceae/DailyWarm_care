		...
		<div class="container px-4 px-lg-0">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto my-2 my-lg-0">
					...
					<!-- 專業服務 -->
					<li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/front-end/updatecarerdata/showCarerData.do?action=showCarerData&carerID=<%=carerID%>">照護資料設定</a></li>
					<!-- 需求列表 -->
					...
					<li class="nav-item dropdown"><a class="nav-link"
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							<li><a class="dropdown-item" id="switchAcct"
								href="./AfterLogin.html">切換帳號</a></li>
				...
				<div class="col-lg-12 col-md-12 col-12">
					...
					<div class="table-responsive">
						<table class="table table-striped text-start">
							...
							<c:forEach var="careOrderPVO" items="${list2}">
								<tbody>
									<tr>
										...
										<c:if test="${careOrderPVO.status == 1}">
											...
											<td><form action="careOrder.do" method="post">
													<input type="hidden" name="careOrderId"
														value="${careOrderPVO.careOrderId}"> <input
														type="hidden" name="action" value="cancel_order">
