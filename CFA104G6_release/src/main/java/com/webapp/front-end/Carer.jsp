                ...
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" id="switchAcct" href="./AfterLogin.html" >切換帳號</a></li>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center text-lift">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-yellow font-weight-bold">About us</h1>
                </div>
                <div class="col-lg-8 align-self-baseline">
                    <p class="text-white mb-5">提供您全方位的照護服務，貼近您的需求，給您完善的照護資源</p>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="serforthree text-center">
                <div class="ser">
                    ...
                    <a class="btn btn-primary fw-bold" href="#" role="button">預約</a>
                </div>
                <div class="ser">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-brown"></i>
                    ...
                    <a class="btn btn-primary fw-bold" href="#" role="button">尋找</a>
                </div>
                <div class="ser">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-brown"></i>
